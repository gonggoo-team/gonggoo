...
public class MemberController {
    ...
    public ApiResponse<MemberResponse> updateMember(@RequestBody MemberUpdateRequest memberUpdateRequest,
        ...
        MemberResponse memberResponse = memberService.update(principal.memberId(), memberUpdateRequest);
        return ApiResponse.success("MEMBER_UPDATED", memberResponse);
    }

    @Operation(summary = "회원 탈퇴")
    @DeleteMapping("/me")
    public ApiResponse<Void> deleteMember(@AuthenticationPrincipal CustomPrincipal principal) {
        memberService.delete(principal.memberId());
    ...
    @GetMapping("/location")
    public ApiResponse<LocationResponse> getLocation(@AuthenticationPrincipal CustomPrincipal principal) {
        LocationResponse locationResponse = memberService.getLocation(principal.memberId());
    ...
    public ApiResponse<MemberResponse> updateLocation(@AuthenticationPrincipal CustomPrincipal principal,
                                                      @RequestBody LocationUpdateRequest locationUpdateRequest) {
        MemberResponse memberResponse = memberService.updateLocation(principal.memberId(), locationUpdateRequest);
