...
public enum ErrorCode {
    ...
    MEMBER_LOGIN_FAILED(HttpStatus.UNAUTHORIZED, "회원가입이 되어있지 않은 이메일입니다.", "이메일이 db안에 존재하지 않습니다"),
    PASSWORD_FAILED(HttpStatus.UNAUTHORIZED, "비밀번호가 틀렸습니다.", "비밀번호가 일치하지 않습니다."),
    ...
    COOPOST_ID_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 공구글이 존재하지 않습니다", "coopostId가 존재하지 않습니다."),
    MEMBER_ID_NOT_FOUND(HttpStatus.NOT_FOUND, "참여자가 존재하지 않습니다.", "채팅 참여자 아이디가 존재하지 않습니다"),
    FAILED_TO_HASH(HttpStatus.INTERNAL_SERVER_ERROR, "채팅방 생성에 실패했습니다", "roomRef 해시 값을 생성할 수 없습니다."),
    SENDER_ID_NOT_FOUND(HttpStatus.NOT_FOUND, "보내는 사람의 아이디가 존재하지 않습니다.", "senderId를 찾을 수 없습니다."),
    ROOM_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "채팅방을 찾을 수 없습니다.", "roomCategory를 찾을 수 없습니다."),
    CHATROOM_NOT_FOUND(HttpStatus.NOT_FOUND, "채팅방을 찾을 수 없습니다", ""),
    CHATROOM_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "채팅방에 유저가 없습니다.", ""),
    INVALID_CURSOR(HttpStatus.BAD_REQUEST, "잘못된 요청입니다.", "Cursor가 유효하지 않습니다."),
    ...
    COOPOST_CLOSED(HttpStatus.CONFLICT, "끝난 공구글입니다.", "공구글 상태가 CLOSED된 공구글입니다."),
    COOPOST_FULL(HttpStatus.CONFLICT, "공구글 정원을 초과했습니다.", "maxParticipants를 초과했습니다.");
